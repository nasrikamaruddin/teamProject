...
<body>
	...
	<div class="contact-form">
		<div class="contact-form-center">
			...
			<form action="membershipPlanPublic.php" method="POST" onsubmit="return validation()" enctype="multipart/form-data">
				...
				<div class="row pull-right">
					<div class="col-md-12">   
						<button type="submit" name="submitPublic" id="submitPublic" class="btn btn-primary" style="width:10em;">Submit</button>					  
					</div>
				</div>
			</form>
            </div>
